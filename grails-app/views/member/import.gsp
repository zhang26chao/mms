...
<div class="nav" role="navigation">
    <ul>
        ...
        <li><g:link controller="member" class="list" action="list"><g:message code="default.list.label" args="[entityName]"/></g:link></li>
    </ul>
</div>
...
<div id="create-member" class="content scaffold-create" role="main">
    ...
    <g:form controller="member" action="doImport" method="post" enctype="multipart/form-data">
        <fieldset class="form">
